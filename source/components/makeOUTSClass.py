...
with open(cMakeListsFileName, 'r') as cMakeListsFile:
    for line in cMakeListsFile:
        if line.startswith( '#add source file here' ):
            cMakeListsFileLines.append( '  source/components/' +  hFileName + '\n')
            cMakeListsFileLines.append( '  source/components/' +  cppFileName + '\n' )
        if line.startswith( '#add test file here' ):
            cMakeListsFileLines.append( '  source/components/' +  gtestFileName + '\n' )
