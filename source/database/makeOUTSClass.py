...
with open(cMakeListsFileName, 'r') as cMakeListsFile:
    for line in cMakeListsFile:
        if line.startswith( '#add source file here' ):
            cMakeListsFileLines.append( '  source/database/' +  hFileName + '\n')
            cMakeListsFileLines.append( '  source/database/' +  cppFileName + '\n' )
        if line.startswith( '#add test file here' ):
            cMakeListsFileLines.append( '  source/database/' +  gtestFileName + '\n' )
